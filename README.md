...
The script *driver_single_mass.py* (contained within the *examples/* folder) is designed to be used to better understand the effects of gravity potential and gravity effect. To run the code, run *python driver_single_mass.py*
